...
import { STAGES, stageDot, stageLabel } from "@/lib/stages";
    ...
    >
      <div className={`${GRID} px-5 py-2.5 transition hover:bg-black/[0.015]`}>
          ...
          <span className="min-w-0">
            ...
            <span className="flex items-center gap-1.5 text-[11.5px] text-ink-soft">
              <span
                ...
                style={{ background: stageDot(deal.stage) }}
              />
        ...
        <input
          ...
          className="field !border-transparent !bg-transparent !px-2 !py-1.5 text-[13px] font-medium hover:!border-line focus:!border-accent focus:!bg-white"
        />
        ...
        {deal.hasLines ? (
          ...
          <input
            ...
            className="field !border-transparent !bg-transparent !px-2 !py-1.5 text-right text-[13px] font-medium tabular-nums hover:!border-line focus:!border-accent focus:!bg-white"
          />
        )}
        ...
        <input
          ...
          className={`field !border-transparent !bg-transparent !px-2 !py-1.5 text-[12.5px] hover:!border-line focus:!border-accent focus:!bg-white ${
        ...
        <input
          ...
          className="field !border-transparent !bg-transparent !px-2 !py-1.5 text-[13px] text-ink-soft hover:!border-line focus:!border-accent focus:!bg-white focus:text-ink"
        />
      </div>
    </li>
  );
...
export default function DealsTable({
  ...
  const groups = useMemo(() => {
    ...
    return STAGES.map((s) => ({
      stage: s,
      items: sorted.filter((r) => r.stage === s.id),
